...
* 选择Prosper_Loan_Data贷款数据集，观察数据，理解原数据集81个变量含义，对数据进行整理、清洗，处理为34个变量，提出四个问题，使用Tableau创建故事，创建可交互的仪表板，上传至TableauPublic，根据反馈进行了修改。
* 查找关于Prosper公司的背景，根据数据字典理解原始数据，
